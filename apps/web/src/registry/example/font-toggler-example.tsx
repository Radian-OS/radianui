...
//     return (
//         <div className="max-w-4xl mx-auto p-4 bg-bg2 shadow-lg rounded-lg">
...
//                     className="w-full p-2 border rounded bg-bg2"
//                 >
...
//             {selectedFont && (
//                 <div
//                     className="p-6 border rounded bg-bg4 text-center"
