...
const drawerVariants = cva("fixed bg-transparent z-50", {
	...
	compoundVariants: [
		{ type: "float", direction: "top", className: "top-2 left-2 w-[calc(100%-1rem)]" },
		{ type: "float", direction: "bottom", className: "bottom-2 left-2 w-[calc(100%-1rem)]" },
		{ type: "float", direction: "left", className: "top-2 left-2 h-[calc(100%-1rem)]" },
		{ type: "float", direction: "right", className: "top-2 right-2 h-[calc(100%-1rem)]" },
