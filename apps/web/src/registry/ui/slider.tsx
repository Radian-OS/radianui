		...
		<div
			...
			<div
				...
				{showSteppers && isSingleThumb && (
					<Button
						isIcon
						className={cn("size-8", { "pointer-events-none cursor-not-allowed opacity-80": props.disabled })}
				...
				{prefixIcon}
				<div className={cn("relative h-full", { "flex-1": orientation === "horizontal", "flex flex-row": orientation === "vertical" })}>
