...
export const sideBarItems: SideBarSection[] = [
	...
	},
	{
		...
		items: [
			...
			{ link: "/documentation/frequently-asked-questions", name: "Frequently Asked Questions" },
	...
	},
	{
		...
		items: [
			{ link: "/documentation/user-authentication", name: "User Authentication" },
			{ link: "/documentation/left-navigation-bar", name: "Left Navigation Bar" },
			{ link: "/documentation/top-navigation-bar", name: "Top Navigation Bar" },
			{ link: "/documentation/application-settings", name: "Application Settings" },
		],
	},
]
