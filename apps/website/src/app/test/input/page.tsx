...
const page = () => {
  return (
    <div className="text-fg1 px-[6rem] py-[3rem]">
      <h4 className="font-heading text-fg1 mb-6 text-[2rem] font-bold">
        Input
      </h4>
        ...
        <DropdownSubContent>
          <DropdownGroup
            ...
            onSelectedChange={(values) =>
              setRounded(values[0] as RoundedOptions)
            }
            minSelectionCount={1}
          >
...
const SearchInputComp = () => {
  ...
  const renderSearchResults = () => {
    if (searchResults.length == 0)
      return <div className="px-[12px] py-[10px]">Not Found</div>;
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="border-stroke bg-bg1 flex h-fit w-full items-center justify-center rounded-[0.5rem] border px-[2rem] py-[3rem]">
        <SearchInput
...
const CalendarComp = () => {
  const [mode, setMode] =
    React.useState<(typeof calendarSelectionModes)[number]>("single");
  const [doubleCalendar, setDoubleCalendar] = React.useState<boolean>(false);
  const [navigatorStyle, setNavigatorStyle] =
    React.useState<(typeof navigatorStyles)[number]>("button");
          ...
          <DropdownSub>
            ...
            <DropdownSubContent>
              <DropdownGroup
                ...
                selectedValues={[mode]}
                onSelectedChange={(values) =>
                  setMode(values[0] as (typeof calendarSelectionModes)[number])
                }
                minSelectionCount={1}
              >
          ...
          <DropdownSub>
            ...
            <DropdownSubContent>
              <DropdownGroup
                ...
                onSelectedChange={(values) =>
                  setDoubleCalendar(values[0] === "true")
                }
                minSelectionCount={1}
              >
                {booleanOptions.map((option) => (
          ...
          <DropdownSub>
            ...
            <DropdownSubContent>
              <DropdownGroup
                ...
                onSelectedChange={(values) =>
                  setNavigatorStyle(
                    values[0] as (typeof navigatorStyles)[number],
                  )
                }
                minSelectionCount={1}
              >
    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="border-stroke bg-bg1 flex h-fit w-full items-center justify-center rounded-[0.5rem] border px-[2rem] py-[3rem]">
        <DateInput
          ...
          size={size}
          disabled={disabled}
          label={label ? "Enter date below" : undefined}
        />
      </div>
    </div>
  );
...
const DatePickerComp = () => {
  ...
  const [showDateRangeShortcut, setShowDateRangeShortcut] =
    React.useState<boolean>(false);
  const [doubleCalendar, setDoubleCalendar] = React.useState<boolean>(false);
  const [navigatorStyle, setNavigatorStyle] = React.useState<
    "button" | "selector"
  >("button");
          ...
          <DropdownSub>
            ...
            <DropdownSubContent>
              <DropdownGroup
                ...
                selectedValues={[mode]}
                onSelectedChange={(values) =>
                  setMode(values[0] as DatePickerModes)
                }
                minSelectionCount={1}
              >
          ...
          <DropdownSub>
            ...
            <DropdownSubContent>
              <DropdownGroup
                ...
                onSelectedChange={(values) =>
                  setShowDateRangeShortcut(values[0] === "true")
                }
                minSelectionCount={1}
              >
                <DropdownItem value="true">Yes</DropdownItem>
          ...
          <DropdownSub>
            ...
            <DropdownSubContent>
              <DropdownGroup
                ...
                selectedValues={[navigatorStyle]}
                onSelectedChange={(values) =>
                  setNavigatorStyle(values[0] as "button" | "selector")
                }
                minSelectionCount={1}
              >
          ...
          <DropdownSub>
            ...
            <DropdownSubContent>
              <DropdownGroup
                ...
                selectedValues={[rounded]}
                onSelectedChange={(values) =>
                  setRounded(values[0] as "rounded" | "square")
                }
                minSelectionCount={1}
              >
...
const SliderComp = () => {
  ...
  return (
    <div className="flex flex-col gap-2">
          ...
          <DropdownSub>
            ...
            <DropdownSubContent>
              <DropdownGroup
                ...
                onSelectedChange={(values) =>
                  setOrientation(values[0] as "horizontal" | "vertical")
                }
                minSelectionCount={1}
              >
      ...
      <div className="border-stroke bg-bg1 flex h-[300px] w-full items-center justify-center rounded-[0.5rem] border px-[2rem] py-[2rem]">
        <Slider
...
const SwitchComp = () => {
  ...
  return (
    <div className="flex flex-col gap-2">
          ...
          <DropdownSub>
            ...
            <DropdownSubContent>
              <DropdownGroup
                ...
                onSelectedChange={(values) =>
                  setSize(values[0] as "20" | "24" | undefined)
                }
                minSelectionCount={1}
              >
      ...
      <div className="border-stroke bg-bg1 flex h-fit w-full items-center justify-center rounded-[0.5rem] border px-[2rem] py-[2rem]">
          ...
          <DropdownSub>
            ...
            <DropdownSubContent>
              <DropdownGroup
                ...
                onSelectedChange={(values) =>
                  setVariant(values[0] as "box" | "flat")
                }
                minSelectionCount={1}
              >
          ...
          <DropdownSub>
            ...
            <DropdownSubContent>
              <DropdownGroup
                ...
                onSelectedChange={(values) =>
                  setMinSelectionCount(Number(values[0]))
                }
                minSelectionCount={1}
              >
