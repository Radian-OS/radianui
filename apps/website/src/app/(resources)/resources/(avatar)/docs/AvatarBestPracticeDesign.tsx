...
const AvatarBestPracticeDesign = () => {
	return (
		<section
			aria-labelledby="avatar-best-practice-design-heading"
			className="mx-auto flex w-full flex-col gap-6 lg:w-200">
			<div className="flex flex-col gap-4">
				<p className="text-primary-text text-sm font-medium">Design</p>
				<h2 id="avatar-best-design-heading" className="heading-4">
					<a href="#avatar-best-design-heading">Avatar Design Best Practices</a>
				</h2>
...
export default AvatarBestPracticeDesign
