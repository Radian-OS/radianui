		...
		<Sidebar className="border-border/70 bg-card border-r">
			...
			<SidebarHeader className="flex flex-col gap-4 p-5 pb-2">
				<div className="flex items-center justify-between">
					<Link
						href="#"
						className="text-foreground flex items-center gap-2 text-sm font-bold tracking-tight transition-opacity hover:opacity-80">
						<HardDrive className="text-foreground size-4" />
						<span>tania.dev</span>
					</Link>
					<div className="flex items-center gap-2">
						<span className="size-2 rounded-full bg-rose-500" />
						<Sun className="text-fg-secondary hover:text-foreground size-3.5 cursor-pointer" />
					</div>
				</div>

				<p className="text-fg-secondary text-xs leading-relaxed">
					I&apos;m <span className="text-foreground font-semibold">Tania</span>,
			...
			<SidebarFooter className="border-border/60 flex flex-col gap-3.5 border-t p-5">
				<div className="text-fg-secondary flex items-center gap-3">
					...
					<Moon className="hover:text-foreground size-3.5 cursor-pointer transition-colors" />
				</div>
