...
export default function Faq5Page() {
	return (
		<section className="bg-background relative min-h-screen w-full px-4 py-16 sm:px-6 md:py-24 lg:px-8">
			<div className="mx-auto max-w-7xl">
				<div className="grid grid-cols-1 items-start gap-8 lg:grid-cols-12 lg:gap-12">
					<div className="flex flex-col gap-8 lg:col-span-7">
						<div className="space-y-4">
							<div className="border-border bg-fill2/50 text-foreground inline-flex items-center gap-2 rounded-full border px-3.5 py-1 text-xs font-medium">
