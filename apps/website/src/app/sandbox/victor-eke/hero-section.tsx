	...
	return (
		<section className="relative flex flex-col justify-between gap-10 py-12 lg:flex-row lg:items-center lg:py-16">
			...
			<div className="flex max-w-2xl flex-col gap-6">
				<h1 className="heading-1 text-fg">
			...
			<div className="flex items-center justify-center lg:w-5/12">
				<div className="border-border bg-card relative flex w-full items-center justify-center overflow-hidden rounded-2xl border p-6 shadow-2xl backdrop-blur-sm">
					<Image
