	...
	return (
		<section className="py-16 md:py-24">
			<div className="mx-auto max-w-5xl px-4">
				<div className="from-primary to-accent relative overflow-hidden rounded-3xl bg-gradient-to-br px-6 py-16 text-center text-white shadow-2xl md:px-12 md:py-20">
					...
					<div className="relative z-10 mx-auto max-w-2xl space-y-5">
						...
						<div className="pt-4">
							...
							<Button
								...
								color="neutral"
								size="40"
								className="gap-2 rounded-full px-6 text-sm font-semibold shadow-xl transition-transform hover:scale-105 active:scale-95">
