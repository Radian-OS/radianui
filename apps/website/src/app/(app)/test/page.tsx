...
// 								<Input value={nameValue} onChange={(e) => setNameValue(e.target.value)} placeholder="Enter your name" />
// 								<Input value={emailValue} onChange={(e) => setEmailValue(e.target.value)} placeholder="test@gmail.com" type="email" />
// 							</div>
// 							<div className="grid grid-cols-2 gap-5">
// 								<Password value={passwordValue} onChange={(e) => setPasswordValue(e.target.value)} placeholder="Enter your password" />
// 								<Input value={verificationCode} onChange={handleVerificationCodeChange} placeholder="Enter 6-digit code here" maxLength={6} />
// 							</div>
// 							<PhoneNumber
// 								label="Phone Number"
// 								value={phoneValue}
