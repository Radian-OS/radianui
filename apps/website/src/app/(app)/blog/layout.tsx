		...
		<section
			...
			<div className="border-soft mx-auto flex max-w-360 flex-col overflow-hidden border border-y-0">
				...
				<DiagonalDivider
					...
					viewBox="0 0 1440 32"
				/>
				<div className="border-soft flex w-full flex-col items-center justify-center gap-8 overflow-hidden border-y px-5 py-22 sm:px-15 sm:py-30 md:py-40">
					<div className="flex flex-col items-center justify-center gap-6">
						<h2
							id="build-section-title"
							className="heading-3 text-fg text-center text-[40px] leading-13 font-medium">
							Build faster with Radian
						</h2>
						<p className="text-fg-secondary text-center text-lg leading-7 font-normal tracking-[-0.18px]">
