...
export const buttonVariants = cva(
	"inline-flex whitespace-nowrap items-center justify-center box-border focus-visible:outline-none focus-visible:ring-offset-2 focus-visible:ring-offset-bg disabled:pointer-events-none hover:cursor-pointer w-fit focus-visible:border-primary-focus focus-visible:ring-primary/50 aria-invalid:ring-error/20 dark:aria-invalid:ring-error/40 aria-invalid:border-error dark:aria-invalid:border-error/50 aria-invalid:ring-1 active:not-aria-[haspopup]:translate-y-px rounded-xl border border-transparent bg-clip-padding text-xs font-medium focus-visible:ring-1 [&_svg:not([class*='size-'])]:size-4",
	{
		variants: {
			variant: {
				strong: "",
				soft: "bg-bg text-fg-secondary hover:bg-fill2/80 aria-expanded:bg-fill2 aria-expanded:text-fg-secondary",
				outline:
					"border-border bg-bg hover:bg-elevation-level1 hover:text-fg dark:bg-primary/30 dark:border-primary dark:hover:bg-primary/50 aria-expanded:bg-elevation-level1 aria-expanded:text-fg",
				ghost:
					"hover:bg-elevation-level1 hover:text-fg dark:hover:bg-bg/50 aria-expanded:bg-elevation-level1 aria-expanded:text-fg",
				link: "",
				glossy: "",
				"glossy-inverted": "",
				smooth: "",
			...
			size: {
				"28": "[&>svg]:size-4 has-data-[icon=inline-end]:pr-1.5 has-data-[icon=inline-start]:pl-1.5 h-6 gap-1 rounded-none px-2 text-xs [&_svg:not([class*='size-'])]:size-3",
