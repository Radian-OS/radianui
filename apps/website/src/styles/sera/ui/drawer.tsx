...
const drawerVariants = cva(
	"bg-bg fixed z-50 flex flex-col gap-6 overflow-hidden",
	{
		variants: {
			variant: {
		...
		compoundVariants: [
			...
			// Handle padding variants
			{
				handle: true,
				direction: "top",
				className: "pt-6 pr-6 pb-8 pl-6",
			},
			{
				handle: true,
				direction: "bottom",
				className: "pt-8 pr-6 pb-6 pl-6",
			},
			{
				handle: true,
				direction: "left",
				className: "pt-6 pr-8 pb-6 pl-6",
			},
			{
				handle: true,
				direction: "right",
				className: "pt-6 pr-6 pb-6 pl-8",
			},
