...
const otpInputVariants = cva(
	cn(
		"inline-flex appearance-none items-center justify-center text-center p-0 leading-none outline-none outline-hidden bg-bg text-fg border-alpha focus-visible:border-primary-hover group-has-disabled:cursor-not-allowed group-has-disabled:text-fg-disabled group-has-disabled:bg-fill2-alpha group-has-disabled:placeholder:text-fg-disabled placeholder:text-fg-tertiary border-b font-semibold shadow-none",
