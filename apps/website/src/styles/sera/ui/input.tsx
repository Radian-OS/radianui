...
const inputVariants = cva(
	`border-alpha text-fg placeholder:text-fg-tertiary focus-visible:ring-primary-focus focus-visible:border-primary disabled:text-fg-disabled disabled:bg-fill2-alpha [&[readonly]]:bg-fill1 file:border-alpha file:text-fg aria-invalid:border-error aria-invalid:ring-error-focus flex w-full items-center border-b bg-transparent transition-[color,box-shadow] file:h-full file:border-0 file:border-e file:border-solid file:bg-transparent file:p-0 file:font-medium file:not-italic focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-60 [&[readonly]]:cursor-not-allowed [&[type=file]]:py-0`,
	{
		variants: {
			size: {
				"28": "h-7 rounded-none px-3 text-[13px] file:me-1.5 file:pe-1.5",
				"32": "h-8 rounded-none px-3 text-sm file:me-3 file:pe-3",
				"36": "h-9 rounded-none px-3.5 text-sm file:me-2.5 file:pe-2.5",
				"40": "h-10 rounded-none px-4 text-sm file:me-3 file:pe-3",
				"44": "h-11 rounded-none px-4 text-base file:me-3.5 file:pe-3.5",
				"48": "h-12 rounded-none px-4.5 text-base file:me-3.5 file:pe-3.5",
			},
		},
		defaultVariants: {
			size: "36",
...
const inputAddonVariants = cva(
	"[&_svg]:text-fg-tertiary bg-elevation-level1 border-alpha text-fg-secondary flex shrink-0 items-center justify-center border shadow-none",
	{
		variants: {
			size: {
				"28": "h-7 min-w-7 rounded-none px-3 text-[13px] [&_svg:not([class*=size-])]:size-4",
				"32": "h-8 min-w-8 rounded-none px-3 text-sm [&_svg:not([class*=size-])]:size-4.5",
				"36": "h-9 min-w-9 rounded-none px-3.5 text-sm [&_svg:not([class*=size-])]:size-5",
				"40": "h-10 min-w-10 rounded-none px-4 text-sm [&_svg:not([class*=size-])]:size-5",
				"44": "h-11 min-w-11 rounded-none px-4 text-base [&_svg:not([class*=size-])]:size-5",
				"48": "h-12 min-w-12 rounded-none px-4.5 text-base [&_svg:not([class*=size-])]:size-5",
			},
			mode: {
				default: "",
...
const inputWrapperVariants = cva(
	`has-[:focus-visible]:ring-primary-accent has-[:focus-visible]:border-primary [&_:is([data-slot=input],[data-slot=currency-input])]:text-fg [&_:is([data-slot=input],[data-slot=currency-input])]:placeholder:text-fg-tertiary [&_svg]:text-fg-tertiary has-[[aria-invalid=true]]:border-error has-[[aria-invalid=true]]:ring-error-accent flex items-center gap-1.5 has-[:focus-visible]:outline-none [&_:is([data-slot=input],[data-slot=currency-input])]:flex [&_:is([data-slot=input],[data-slot=currency-input])]:h-auto [&_:is([data-slot=input],[data-slot=currency-input])]:w-full [&_:is([data-slot=input],[data-slot=currency-input])]:rounded-none [&_:is([data-slot=input],[data-slot=currency-input])]:border-0 [&_:is([data-slot=input],[data-slot=currency-input])]:bg-transparent [&_:is([data-slot=input],[data-slot=currency-input])]:p-0 [&_:is([data-slot=input],[data-slot=currency-input])]:shadow-none [&_:is([data-slot=input],[data-slot=currency-input])]:transition-colors [&_:is([data-slot=input],[data-slot=currency-input])]:outline-none [&_:is([data-slot=input],[data-slot=currency-input])]:focus-visible:ring-0 [&_:is([data-slot=input],[data-slot=currency-input])]:disabled:cursor-not-allowed [&_:is([data-slot=input],[data-slot=currency-input])]:disabled:opacity-50 [&_:is([data-slot=input],[data-slot=currency-input])]:data-focus-within:border-0 [&_:is([data-slot=input],[data-slot=currency-input])]:data-focus-within:ring-0 [&_:is([data-slot=input],[data-slot=currency-input])]:data-focus-within:ring-transparent [&_[data-slot=datefield]]:grow [&_svg]:shrink-0`,
	{
		variants: {
			size: {
				"28": "gap-2 [&_svg:not([class*=size-])]:size-4",
				"32": "gap-2.5 [&_svg:not([class*=size-])]:size-4.5",
				"36": "gap-2.5 [&_svg:not([class*=size-])]:size-5",
				"40": "gap-2.5 [&_svg:not([class*=size-])]:size-5",
				"44": "gap-2.5 [&_svg:not([class*=size-])]:size-5",
				"48": "gap-3 [&_svg:not([class*=size-])]:size-5",
			},
			disabled: {
				true: "has-[:focus-visible]:border-alpha bg-fill1 [&_svg]:text-fg-tertiary cursor-not-allowed opacity-60 has-[:focus-visible]:ring-0",
				false: "",
			},
		},
		defaultVariants: {
