...
const inputVariants = cva(
	`flex w-full items-center border-alpha transition-[color,box-shadow] text-fg placeholder:text-fg-tertiary focus-visible:ring-primary-focus focus-visible:border-primary focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-60 disabled:text-fg-disabled disabled:bg-fill2-alpha [&[readonly]]:bg-fill1 [&[readonly]]:cursor-not-allowed file:h-full [&[type=file]]:py-0 file:border-solid file:border-alpha file:bg-transparent file:font-medium file:not-italic file:text-fg file:p-0 file:border-0 file:border-e aria-invalid:border-error aria-invalid:ring-error-focus border-b bg-transparent`,
	{
		variants: {
			size: {
				"28": "h-7 file:pe-1.5 file:me-1.5 px-3 text-[13px]",
				"32": "h-8 file:pe-3 file:me-3 px-3 text-sm",
				"36": "h-9 file:pe-2.5 file:me-2.5 px-3.5 text-sm",
				"40": "h-10 file:pe-3 file:me-3 px-4 text-sm",
				"44": "h-11 file:pe-3.5 file:me-3.5 px-4 text-base",
				"48": "h-12 file:pe-3.5 file:me-3.5 px-4.5 text-base",
			},
		},
		defaultVariants: {
			size: "36",
...
const inputAddonVariants = cva(
	"flex items-center shrink-0 justify-center [&_svg]:text-fg-tertiary bg-elevation-level1 border-alpha text-fg-secondary border shadow-none",
	{
		variants: {
			size: {
				"28": "h-7 min-w-7 [&_svg:not([class*=size-])]:size-4 px-3 text-[13px]",
				"32": "h-8 min-w-8 [&_svg:not([class*=size-])]:size-4.5 px-3 text-sm",
				"36": "h-9 min-w-9 [&_svg:not([class*=size-])]:size-5 px-3.5 text-sm",
				"40": "h-10 min-w-10 [&_svg:not([class*=size-])]:size-5 px-4 text-sm",
				"44": "h-11 min-w-11 [&_svg:not([class*=size-])]:size-5 px-4 text-base",
				"48": "h-12 min-w-12 [&_svg:not([class*=size-])]:size-5 px-4.5 text-base",
			},
			mode: {
				default: "",
