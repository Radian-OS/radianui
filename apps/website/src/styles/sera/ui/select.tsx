...
const selectTriggerVariants = cva(
	"flex w-full items-center outline-none transition-shadow [&>span]:line-clamp-1 border-border text-fg data-placeholder:text-fg-tertiary focus-visible:ring-primary-focus focus-visible:border-primary aria-invalid:border-error aria-invalid:ring-error [[data-invalid=true]_&]:border-error [[data-invalid=true]_&]:ring-error border-b bg-transparent shadow-none focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50",
	{
		variants: {
			size: {
				"28": "gap-0.5 h-7 px-3 py-1.5 text-[13px]",
				"32": "gap-0.5 h-8 px-3 py-1.5 text-sm",
				"36": "gap-1 h-9 px-3.5 py-2 text-sm",
				"40": "gap-1 h-10 px-4 py-2.5 text-sm",
				"44": "gap-1 h-11 px-4 py-2.5 text-base",
				"48": "gap-1 px-4.5 h-12 py-3 text-base",
			},
		},
		defaultVariants: {
			size: "36",
...
function SelectItem({ className, children, ...props }: SelectItemProps) {
	...
	return (
		<SelectPrimitive.Item
			...
			className={cn(
				"outline-hidden focus:bg-fill2-alpha data-disabled:pointer-events-none data-disabled:opacity-50 relative flex w-full cursor-pointer select-none items-center py-2 text-sm",
