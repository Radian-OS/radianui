	...
	return (
		<DayPicker
			classNames={{
				...
				day_button:
					"text-center cursor-pointer size-9 p-0 group-data-disabled:pointer-events-none text-fg rounded-lg text-sm font-medium hover:bg-fill1-alpha hover:group-data-selected:bg-primary group-data-disabled:line-through group-data-selected:bg-primary group-data-selected:text-white hover:group-[.rdp-outside]:group-data-selected:bg-primary group-[.rdp-outside]:group-data-selected:text-white group-[.range-middle]:group-[.rdp-outside]:group-data-selected:text-primary-text hover:group-[.range-middle]:group-[.rdp-outside]:group-data-selected:bg-primary-accent group-data-disabled:text-fg-tertiary group-data-outside:text-fg-tertiary group-data-today:border group-data-today:border-primary group-data-today:text-primary-text group-data-today:group-data-selected:text-white hover:group-[.range-middle]:group-data-selected:bg-primary-accent group-[.range-middle]:group-data-selected:bg-primary-accent group-[.range-middle]:group-data-selected:text-primary-text group-data-selected:group-data-outside:text-primary-text",
				button_previous:
