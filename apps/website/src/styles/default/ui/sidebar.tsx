...
import { DialogTitle } from "@/styles/default/ui/dialog"
import { Divider } from "@/styles/default/ui/divider"
import { Drawer, DrawerContent } from "@/styles/default/ui/drawer"
...
export const sidebarMenuButtonVariants = cva(
	...
	"peer/menu-button hover:bg-sidebar-accent hover:text-sidebar-accent-fg rounded-control-md [&>svg]:text-fg-secondary flex w-full cursor-pointer items-center gap-2 truncate overflow-hidden p-2 text-left text-sm font-medium outline-hidden transition-[width,height,padding] group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>a:last-child]:min-w-0 [&>a:last-child]:truncate [&>span:last-child]:min-w-0 [&>span:last-child]:truncate [&>svg]:size-5 [&>svg]:shrink-0",
	{
		variants: {
			variant: {
				strong:
			...
			<Tooltip delayDuration={0}>
				<div
					...
					className={cn(
						...
						// Style hook
						"bg-bg has-data-[theme=default]:bg-bg has-data-[theme=gray]:has-data-[variant=inset]:bg-sidebar has-data-[theme=inverse]:has-data-[variant=inset]:bg-black",
						className
					)}
					{...props}>
					{children}
	...
	return (
		<div
			...
			className={cn(
				...
				// Style hooks
				"hover:after:bg-sidebar-border after:bg-transparent",
	...
	if (collapsible === "none") {
		return (
			<div
				...
				className={cn(
					// Structural
					"sticky top-0 flex h-svh w-(--sidebar-width) flex-col",
					// Style hook
			...
			<div
				...
				<div
					...
					className={cn(
						...
						variant === "floating" &&
							"border-sidebar-border rounded-xl border shadow-sm",
	...
	return (
		<main
			...
			className={cn(
				...
				"md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:not-peer-data-[collapsible=icon]:peer-data-[state=collapsed]:ml-2",
				// Style hook
				"peer-data-[theme=default]:border-sidebar-border peer-data-[theme=gray-body]:bg-fill1 peer-data-[theme=default]:peer-data-[variant=inset]:border md:peer-data-[variant=inset]:shadow-sm",
				className
			)}
			{...props}
		/>
...
function SidebarGroupAction({
	...
	return (
		<Comp
			...
			className={cn(
				// Structural
				"ring-sidebar-ring absolute top-3.5 right-2 flex aspect-square w-5 items-center justify-center rounded-md p-0 outline-hidden transition-transform focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
...
function SidebarMenuAction({
	...
	return (
		<Comp
			...
			className={cn(
				// Structural
				"ring-sidebar-ring absolute top-1.5 right-1 flex aspect-square w-5 items-center justify-center rounded-md p-0 outline-hidden transition-transform focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
				"after:absolute after:-inset-2 md:after:hidden",
				...
				// Style hook
				"text-sidebar-fg hover:bg-sidebar-accent hover:text-sidebar-accent-fg peer-hover/menu-button:text-sidebar-accent-fg",
				showOnHover &&
					"peer-data-[active=true]/menu-button:text-sidebar-accent-fg",
				className
			)}
			{...props}
		/>
...
function SidebarMenuSubButton({
	...
	return (
		<Comp
			...
			className={cn(
				// Structural
				"ring-sidebar-ring flex min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-md px-2 outline-hidden focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 [&>a:last-child]:min-w-0 [&>a:last-child]:truncate [&>span:last-child]:min-w-0 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
				size === "28" && "h-7 text-xs",
				size === "32" && "h-8 text-sm",
				"group-data-[collapsible=icon]:hidden",
				// Style hook
				"text-sidebar-fg hover:bg-sidebar-accent hover:text-sidebar-accent-fg data-[active=true]:bg-sidebar-accent data-[active=true]:text-sidebar-accent-fg [&>svg]:text-sidebar-accent-fg",
				className
			)}
			{...props}
		/>
