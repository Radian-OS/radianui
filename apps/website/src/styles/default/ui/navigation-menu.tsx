...
const navigationMenuTriggerStyle = cva(
	"group bg-bg hover:bg-fill1-alpha hover:text-fg focus:bg-fill1-alpha focus:text-fg focus-visible:ring-fill4/50 data-[state=open]:bg-fill1 data-[state=open]:text-fg data-[state=open]:hover:bg-fill1-alpha data-[state=open]:focus:bg-fill1-alpha inline-flex h-9 w-max cursor-pointer items-center justify-center rounded-md px-4 py-2 text-sm font-medium transition-[color,box-shadow] outline-none focus-visible:ring-[3px] focus-visible:outline-1 disabled:pointer-events-none disabled:opacity-50"
)
