...
function DropdownContent({ className, ...props }: DropdownContentProps) {
	return (
		<DropdownMenuPrimitive.Content
			...
			align="start"
			className={cn(
				"border-border bg-popover drop-shadow-xs min-w-[var(--radix-dropdown-menu-trigger-width)] gap-0.5 border p-1.5",
...
function DropdownItem({ className, inset, ...props }: DropdownItemProps) {
	return (
		<DropdownMenuPrimitive.Item
			...
			className={cn(
				"text-fg focus:bg-fill1-alpha data-disabled:text-fg-disabled data-disabled:[&_*]:text-fg-disabled [&_svg]:text-fg-secondary gap-2 px-2 py-1.5 text-sm [&_svg:not([class*='size-'])]:size-4",
...
function DropdownCheckboxItem({
	...
	return (
		<DropdownMenuPrimitive.CheckboxItem
			...
			className={cn(
				"focus:bg-fill2-alpha [&_svg]:text-fg-secondary gap-2 py-1.5 text-sm [&_svg:not([class*='size-'])]:size-5",
...
function DropdownSubTrigger({
	...
	return (
		<DropdownMenuPrimitive.SubTrigger
			...
			className={cn(
				"data-[state=open]:bg-fill1-alpha focus:bg-fill2-alpha [&_svg]:text-fg-secondary gap-2 px-2 py-1.5 text-sm [&_svg:not([class*='size-'])]:size-4",
	...
	return (
		<DropdownMenuPrimitive.Portal>
			<DropdownMenuPrimitive.SubContent
				...
				className={cn(
					"border-border bg-popover drop-shadow-xs min-w-36 border p-1.5",
					"z-50 flex flex-col items-stretch justify-start",
					"data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
					className
				)}
