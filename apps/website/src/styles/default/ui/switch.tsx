...
const switchThumbVariants = cva(
	"data-[state=checked]:bg-primary-fg pointer-events-none flex items-center justify-center bg-white shadow-lg ring-0 transition-transform data-[state=unchecked]:translate-x-[3px] rtl:data-[state=checked]:-translate-x-[calc(100%-3px)] rtl:data-[state=unchecked]:-translate-x-[3px]",
	{
		variants: {
			shape: {
				pill: "rounded-full",
