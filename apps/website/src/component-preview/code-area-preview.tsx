...
const CodeAreaPreview = () => {
  ...
  const [showLineNumbers, setShowLineNumbers] =
    useState<showLineNumbersType>("false");
            ...
            <DropdownContent className="min-w-20">
              <DropdownSub>
                ...
                <DropdownSubContent>
                  ...
                  >
                    <DropdownItem value="one-dark-pro">
                      one-dark-pro
                    </DropdownItem>
                    <DropdownItem value="night-owl">night-owl</DropdownItem>
                    <DropdownItem value="github-dark-default">
                      github-dark-default
                    </DropdownItem>
                    <DropdownItem value="material-theme">
                      material-theme
                    </DropdownItem>
                    <DropdownItem value="github-light">
                      github-light
                    </DropdownItem>
              ...
              <DropdownSub>
                ...
                <DropdownSubContent>
                  <DropdownGroup
                    ...
                    onSelectedChange={(keys) => {
                      setShowLineNumbers(
                        Array.from(keys)[0] as showLineNumbersType,
                      );
                    }}
                  >
                    <DropdownItem value="true">true</DropdownItem>
