...
const SocialButtonPreview = () => {
  ...
  size={${size}}
  variant="${variant}" 
  className="bg-[#3B7DED] disabled:bg-[#3B7DED]/50"
  >
  <GoogleIcon/>
  ...
  disabled={${disabled === "true" ? true : false}}
  size={${size}}
  className="bg-[#1778F2] disabled:bg-[#1778F2]/50"
  >
  <FacebookIcon/>
  Continue with Facebook
  </Button>`;
  ...
  const getButtonDisplay = () => {
    if (socials === "google" && variant === "strong") {
      return (
        <Button disabled={disabled === "true" ? true : false} size={size} variant="strong" className="bg-[#3B7DED] disabled:bg-[#3B7DED]/50">
    ...
    if (socials === "facebook" && variant === "strong") {
      return (
        <Button className="bg-[#1778F2] disabled:bg-[#1778F2]/50" disabled={disabled === "true" ? true : false} size={size}  >
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
