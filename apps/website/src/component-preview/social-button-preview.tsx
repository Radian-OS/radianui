...
const SocialButtonPreview = () => {
  ...
  const getCodeDisplay = () => {
    ...
    <Button disabled={${disabled==="true"?true:false}} size="${size}">
      <Icon />
      Continue with Google
    </Button>
    ` : socials === "X" ? `
    ...
    ` : socials === "facebook" ? `
    <Button disabled={${disabled==="true"?true:false}} size="${size}" color="information" variant="neutral-outline">
      <Icon />
...
<Button disabled={${disabled==="true"?true:false}} size="${size}">
  ...
  Continue with Google
    ...
    if (socials === "X") {
      return `<Button disabled={${disabled==="true"?true:false}} size="${size}" variant="neutral-outline">
  <Icon />
  Continue with X(Twitter)
</Button>
...
<Button disabled={${disabled==="true"?true:false}} size="${size}" className="bg-inverse-black text-inverse-white hover:bg-inverse-black/70 focus-visible:ring-inverse-black">
  ...
  Continue with Apple
    ...
    if (socials === "facebook") {
      return `<Button disabled={${disabled==="true"?true:false}} size="${size}" color="information" variant="neutral-outline">
  <Icon />
  Continue with Facebook
</Button>
