        ...
        <div className="flex h-[420px] flex-col items-center justify-center gap-3 overflow-auto rounded-xl border">
          {
            (socials === "google" ? (
              <>
                <Button disabled={disabled==="true"?true:false} size={size} variant="neutral-outline" className="w-fit drop-shadow" >
            ...
            (socials === "X" ? (
              <>
                ...
                <Button disabled={disabled==="true"?true:false} size={size} className="bg-inverse-black hover:bg-inverse-black/70 active:bg-inverse-black/80 dark:bg-inverse-white dark:hover:bg-inverse-white/70 dark:active:bg-inverse-white/80 w-fit focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-inverse-black disabled:bg-inverse-black/50" >
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M17.7512 3H20.818L14.1179 10.6246L22 21H15.8284L10.9946 14.7074L5.46359 21H2.39494L9.5613 12.8446L2 3H8.32828L12.6976 8.75169L17.7512 3ZM16.6748 19.1723H18.3742L7.4049 4.73169H5.58133L16.6748 19.1723Z" fill="currentColor" />
                  </svg>
                  Continue with X(Twitter)
            ...
            (socials === "facebook" ? (
              <>
                <Button disabled={disabled==="true"?true:false} size={size} color="information" variant="neutral-outline" className="w-fit drop-shadow" >
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Button disabled={disabled==="true"?true:false} size={size} color="information" className="w-fit drop-shadow" >
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
