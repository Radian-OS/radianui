...
Continue with Facebook
  ...
  Continue with Github
	...
	const getButtonDisplay = () => {
		...
		if (socials === "google" && variant === "neutral-outline") {
			return (
				<Button disabled={disabled === "true" ? true : false} size={size} variant="outline">
					<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path
		...
		if (socials === "facebook" && variant === "neutral-outline") {
			return (
				<Button className="disabled:bg-bg-base/50" disabled={disabled === "true" ? true : false} size={size} variant="outline">
					<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path
