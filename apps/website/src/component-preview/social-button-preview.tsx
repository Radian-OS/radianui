...
Continue with Google
  ...
  disabled={${disabled === "true" ? true : false}}
  size={${size}}
  className="bg-inverse-black text-inverse-white hover:bg-inverse-black/70 focus-visible:ring-inverse-black"
  >
  <AppleIcon/>
  Continue with Apple
  </Button>`;
...
Continue with Facebook
  ...
  const getButtonDisplay = () => {
    if (socials === "google" && variant === "strong") {
      return (
        <Button disabled={disabled === "true" ? true : false} size={size} variant="strong" className="bg-[#3B7DED] hover:bg-[#3B7DED]/90 disabled:bg-[#3B7DED]/50 focus-visible:ring-[#3B7DED]">
    ...
    if (socials === "apple" && variant === "strong") {
      return (
        <Button disabled={disabled === "true" ? true : false} size={size} className="bg-inverse-black text-inverse-white hover:bg-inverse-black/70  focus-visible:ring-inverse-black" >
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    if (socials === "facebook" && variant === "strong") {
      return (
        <Button className="bg-[#1778F2] hover:bg-[#1778f2]/90 focus-visible:ring-[#1778F2]" disabled={disabled === "true" ? true : false} size={size}  >
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
