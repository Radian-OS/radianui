...
// 		() => ({
// 			username: () => <Input name="username" id="username" className="w-full" value={formData.username} onChange={handleChange} placeholder="Enter username" />,
// 			password: () => <Password name="password" id="password" className="w-full" placeholder="Enter password" onChange={handleChange} value={formData.password} />,
...
// 			),
// 		}),
// 		[formData, errors, handleChange, handleColorChange, handleSelectChange, selectValues, handleOtpChange, uploadedFiles, handleFileChange, selectedDate, handleTextAreaChange]
// 	)
