  ...
  const getAlertContent = (type: string) => {
    const contents = {
      ...
      info: {
        ...
        message:
          "Your application has been successfully updated with new information",
      },
      success: {
      ...
      warning: {
        ...
        message:
          "Please review your settings before proceeding with the operation",
      },
      danger: {
                  ...
                  <DropdownSubContent>
                    <DropdownGroup
                      ...
                      onSelectedChange={(keys) =>
                        setType(Array.from(keys)[0] as typeof type)
                      }
                      minSelectionCount={1}
                      selectedValues={[type]}
                    >
