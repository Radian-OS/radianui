...
const DrawerPreview = () => {
  const [variant, setVariant] = useState<
    "float" | "default" | "rounded" | undefined
  >("default");
  const [position, setPosition] = useState<
    "right" | "bottom" | "left" | "top" | undefined
  >("right");
  const [handle, setHandle] = useState<"true" | "false">("false");
  const [backdrop, setBackdrop] = useState<
    "blur" | "overlay" | null | undefined
  >("overlay");
              ...
              <DropdownSub>
                ...
                <DropdownSubContent>
                  <DropdownGroup
                    selectionMode="single"
                    onSelectedChange={(keys) =>
                      setHandle(Array.from(keys)[0] as "true" | "false")
                    }
