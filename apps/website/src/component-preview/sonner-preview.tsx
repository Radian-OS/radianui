              ...
              <DropdownGroup>
                <DropdownSub>
                  ...
                  <DropdownSubContent>
                    ...
                    >
                      <DropdownItem value="bottom-right">
                        Bottom Right
                      </DropdownItem>
                      ...
                      <DropdownItem value="bottom-left">
                        Bottom Left
                      </DropdownItem>
                      <DropdownItem value="bottom-center">
                        Bottom Center
                      </DropdownItem>
                    </DropdownGroup>
                  </DropdownSubContent>
                ...
                <DropdownSub>
                  ...
                  <DropdownSubContent>
                    <DropdownGroup
                      ...
                      onSelectedChange={(keys) => {
                        setVisibleToasts(
                          Array.from(keys)[0] as typeof visibleToasts,
                        );
                        setKey((k) => k + 1);
                      }}
                      minSelectionCount={1}
