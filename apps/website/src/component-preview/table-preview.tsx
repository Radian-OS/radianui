                ...
                <DropdownSub>
                  ...
                  <DropdownSubContent>
                    <DropdownGroup
                      ...
                      onSelectedChange={(keys) => {
                        setVerticalLine(
                          Array.from(keys)[0] as typeof verticalLine,
                        );
                        setKey((k) => k + 1);
                      }}
                      minSelectionCount={1}
                ...
                <DropdownSub>
                  ...
                  <DropdownSubContent>
                    <DropdownGroup
                      ...
                      onSelectedChange={(keys) =>
                        setTableHeight(
                          Array.from(keys)[0] as typeof tableHeight,
                        )
                      }
                      minSelectionCount={1}
                ...
                <DropdownSub>
                  ...
                  <DropdownSubContent>
                    <DropdownGroup
                      selectionMode="single"
                      onSelectedChange={(keys) =>
                        setHeader(Array.from(keys)[0] as typeof header)
                      }
                      minSelectionCount={1}
                ...
                <DropdownSub>
                  ...
                  <DropdownSubContent>
                    <DropdownGroup
                      selectionMode="single"
                      onSelectedChange={(keys) =>
                        setRow(Array.from(keys)[0] as typeof row)
                      }
                      minSelectionCount={1}
                      selectedValues={[row]}
                    >
