...
const PopoverPreview = () => {
  const [closeIconVisibility, setCloseIconVisibility] =
    useState<CloseIconVisibility>("hidden");
                  ...
                  <DropdownGroup
                    ...
                    onSelectedChange={(keys) =>
                      setCloseIconVisibility(
                        Array.from(keys)[0] as CloseIconVisibility,
                      )
                    }
                    minSelectionCount={1}
              ...
              <DropdownSub>
                ...
                <DropdownSubContent>
                  <DropdownGroup
                    selectionMode="single"
                    onSelectedChange={(keys) =>
                      setBackdrop(Array.from(keys)[0] as Backdrop)
                    }
                    minSelectionCount={1}
          ...
          <Modal backdrop={backdrop} closeIconVisibility={closeIconVisibility}>
            ...
            <ModalContent>
              ...
              <ModalHeader className="text-center">
                ...
                <ModalDescription>
                  Streamline your API requests by using Github SDK’s and
                  automate all your tickets
                </ModalDescription>
              </ModalHeader>
              <div className="flex flex-col gap-4">
                ...
                <Input
                  label="API Key"
                  placeholder="e.g.0405a-5598e-gg54gg "
                  type="text"
                  name="account-name"
                />
                <Input
                  label="Workspace URL"
                  placeholder="e.g. radianos.com/workspace"
                  type="email"
                  name="account-name"
                />
              </div>
