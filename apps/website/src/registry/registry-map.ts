...
export const registryExampleGroups: RegistryExampleGroup[] = [
	...
	},
	{
		name: "alert",
		examples: [
			"alert-close-example-preview",
			"alert-colors-example",
	...
	},
	{
		...
		examples: [
			...
			"destructive-dialog-with-divider",
		],
	},
	{
		name: "aspect-ratio",
	...
	},
	{
		...
		examples: [
			...
			"avatar-size",
			"avatar-status",
			"custom-avatar-with-badge",
			"custom-avatar-with-ring",
			"custom-avatar-with-status",
		],
	},
	{
		name: "badge",
		examples: [
			...
			"badge-example",
			"badge-icon-example",
			"badge-nested-example",
			"badge-rounded-example",
			"badge-size-example",
	...
	},
	{
		name: "banner",
		examples: [
			"banner-black-friday-example",
			"banner-color-example",
			"banner-error-example",
			"banner-example-preview",
			"banner-floating-example",
			"banner-primary-example",
			"banner-success-example",
			"banner-variants-example",
		],
	},
	{
		name: "breadcrumb",
		examples: [
			"breadcrumb-card-design",
			"breadcrumb-preview",
			"breadcrumb-with-dot",
	...
	},
	{
		...
		examples: [
			...
			"button-compact-example",
			"button-elevated-example",
			"button-example-disabled",
			"button-example-preview",
			"button-example-rounded",
			"button-fancy-example",
			"button-glossy-example",
			"button-group-example",
			"button-input-example",
			"button-size-example",
			"button-smooth-example",
			"button-split-example",
	...
	},
	{
		name: "calendar",
		examples: [
			"calendar-footer-preview",
			"calendar-preview",
			"calendar-scrollable-time",
			"calendar-time-input",
			"calendar-year-month-selector-example",
			"multiple-months-calendar-example",
			"quick-selection-preview",
			"time-picker-calendar-preview",
		],
	},
	{
		name: "card",
		examples: ["card-info-example", "card-preview", "card-with-list-example"],
	},
	{
		name: "carousel",
		examples: [
	...
	},
	{
		...
		examples: [
			...
			"code-theme-example",
			"code-with-copy-example",
			"code-with-tabs-preview",
		],
	},
	{
		name: "collapsible",
	...
	{ name: "command", examples: ["command-preview"] },
	{
		name: "currency-input",
		examples: [
			"currency-decimal-separator",
			"currency-decimals-limit",
			"currency-input-example",
			"currency-locale-config",
			"currency-max-value-example",
			"currency-nodecimal-example",
			"currency-prefix-example",
			"currency-select-with-custom-prefix",
			"currency-separators-example",
			"currency-step-example",
			"currency-with-input-group",
			"currency-with-input-wrapper",
	...
	},
	{
		name: "divider",
		examples: [
			"divider-badge-preview",
			"divider-plain-text-preview",
			"divider-preview",
	...
	},
	{
		name: "drawer",
		examples: [
			"drawer-backdrop-example",
			"drawer-example-preview",
			"drawer-handle-preview",
			"drawer-position-example",
			"drawer-variant-example",
		],
	},
	{
		name: "dropdown",
		examples: [
			"dropdown-preview",
			"dropdown-with-checkbox-example",
			"dropdown-with-dropdown-checkbox",
			"dropdown-with-radio",
			"user-profile-dropdown-example",
		],
	},
	{
		name: "empty",
	...
	{ name: "form", examples: ["form-preview", "sign-in-form", "sign-up-form"] },
	{
		name: "hover-card",
		examples: [
			"hover-card-group-quick-view",
			"hover-card-influencer-profile",
			"hover-card-post-images-and-stats",
			"hover-card-preview",
			"hover-card-user-mini-profile",
		],
	},
	{
		name: "input",
	...
	{ name: "label", examples: ["label-preview"] },
	{
		...
		examples: [
			...
			"otp-field-form",
			"otp-field-preview",
			"otp-field-type-password",
			"otp-field-validation-type",
			"otp-size",
		],
	},
	{
		name: "pagination",
		examples: [
			"pagination-card-example",
			"pagination-example-preview",
			"pagination-text-example",
	...
	},
	{
		...
		examples: [
			...
			"international-phone-hook-example",
			"national-phone-number-example",
			"only-countries-phone",
			"phone-number-example",
			"phone-number-no-formatting",
			"phone-number-static",
			"preferred-countries-phone",
		],
	},
	{
		name: "popover",
	...
	{
		name: "progress",
		examples: ["downloading-progress", "progress-example", "progress-preview"],
	},
	{
		name: "radio-group",
		examples: [
	...
	{
		name: "resizable",
		examples: ["handle-on-hover", "resizable-example", "resizable-preview"],
	},
	{ name: "scroll-area", examples: ["scroll-area-preview"] },
	{
		name: "select",
		examples: [
	...
	{ name: "skeleton", examples: ["skeleton-preview"] },
	{
		name: "slider",
		examples: [
			"price-range",
	...
	{
		name: "spinner",
		examples: ["spinner-colors", "spinner-preview", "spinner-sizes"],
	},
	{
		name: "switch",
		examples: [
