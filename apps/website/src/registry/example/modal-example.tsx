  ...
  <Modal>
    ...
    <ModalContent>
      <ModalHeader>
        ...
        <ModalDescription>
          Are you sure you want to change the content in this section.
        </ModalDescription>
      </ModalHeader>
  ...
  <Modal closeIconVisibility="hover">
    ...
    <ModalContent>
      <ModalHeader>
        ...
        <ModalDescription>
          Select a template to start working on your project
        </ModalDescription>
      </ModalHeader>
  ...
  <Modal closeIconVisibility="hidden">
    ...
    <ModalContent>
      ...
      <ModalHeader className="text-center">
        ...
        <ModalDescription>
          This is a sample modal to stress test the xyz container in a modal.
          Here is a sample
        </ModalDescription>
      </ModalHeader>
  ...
  <Modal closeIconVisibility="hidden">
    ...
    <ModalContent>
      ...
      <ModalHeader>
        ...
        <ModalDescription>
          Join the Radian team to unlock unlimited features and subsets of
          products
        </ModalDescription>
      </ModalHeader>
      <ModalFooter className="flex-col">
