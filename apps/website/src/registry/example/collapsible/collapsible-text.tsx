...
export default function CollapsibleText() {
	...
	return (
		<Collapsible open={isOpen} onOpenChange={setIsOpen} className="w-[500px] text-sm/6">
			<p>
			...
			<CollapsibleContent className="data-[state=closed]:animate-collapsible-up data-[state=open]:animate-collapsible-down">
				...
				<p>
					...
					mode out of the box. Whether you are building a simple landing page or a complex dashboard, RadianOS has the components you need to create exceptional user experiences.
				</p>
			</CollapsibleContent>
