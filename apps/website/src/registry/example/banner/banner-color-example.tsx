	...
	return (
		<div className="max-w-160 flex w-full flex-col items-center justify-center gap-6">
			<Banner>
				...
				<BannerDescription className="truncate">Information news about product</BannerDescription>
			</Banner>
			...
			<Banner color="success">
				...
				<BannerDescription className="truncate">User achievement or success message</BannerDescription>
			</Banner>
			<Banner color="error">
				<BannerIcon>
					<Bug size={20} />
				...
				<BannerDescription className="truncate">Alert user of a problem or error</BannerDescription>
			</Banner>
			<Banner color="warning">
				...
				<BannerDescription className="truncate">Notify user of potential problem that may occur</BannerDescription>
			</Banner>
			<Banner color="info">
				<BannerIcon>
					<Feather size={20} />
