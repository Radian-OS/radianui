...
const BannerErrorExample = () => {
	...
	return (
		<div className="max-w-160 flex w-full flex-col items-center justify-center gap-6">
			{bannerVisible && (
				<Banner className="p-3" onClose={handleClose} color="error" variant="strong">
					<BannerIcon>
			...
			<Banner color="error" className="p-3">
				...
				<BannerContent className="flex sm:flex-row sm:gap-2">
					...
					<BannerDescription className="truncate">To allow others to view this page</BannerDescription>
				</BannerContent>
