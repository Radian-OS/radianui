    ...
    <div className="my-4 flex flex-col gap-4">
      <div className="flex flex-col gap-5 md:flex-row">
        <div className="flex gap-2">
          <label>Variant</label>
          <select
            onChange={(e) => setVariant(e.target.value as Variants)}
        ...
        <div className="flex gap-2">
          <label>Width</label>
          <select
            onChange={(e) => setWidth(e.target.value as "fit" | "full")}
            defaultValue={"fit"}
          >
      ...
      <div className={`flex max-w-[40rem] flex-col gap-4`}>
        ...
        <Tabs defaultValue="account" variant={variant} size={size}>
          ...
          <TabsContent value="account">
            ...
            debitis esse iure mollitia a non .
          </TabsContent>
          <TabsContent value="password">
            d suscipit explicabo. Culpa commodi velit quam nam aliquid labore
            sit, earum nulla similique deleniti adipisci explicabo assumenda
            magni molestiae! Dolorum!
          </TabsContent>
        </Tabs>
        <Tabs defaultValue="account" variant={variant} size={size}>
          <TabsList width={width}>
