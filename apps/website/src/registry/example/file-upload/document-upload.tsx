...
import { AlertCircleIcon, FileArchiveIcon, FileIcon, FileSpreadsheetIcon, FileTextIcon, FileUpIcon, HeadphonesIcon, ImageIcon, VideoIcon, XIcon } from "lucide-react"
		...
		<div className="w-90 flex flex-col gap-2">
			...
			<div
				...
				<div className="flex flex-col items-center justify-center text-center">
					...
					<p className="text-fg-secondary mb-2 text-xs">Drag & drop or click to browse</p>
			...
			{files.length > 0 && (
				<div className="space-y-2">
					{files.map((file) => (
						<div key={file.id} className="bg-bg flex items-center justify-between gap-2 rounded-lg border p-2 pe-3">
