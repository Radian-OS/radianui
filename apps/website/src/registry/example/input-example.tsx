...
const InputExample = () => {
  ...
  return (
    <div className="mt-4 mb-20 flex max-w-[25rem] flex-col gap-2">
      ...
      />
      <Password
        errorMsg="The input field has an error"
        hasError={true}
        size={size}
        rounded={rounded}
      />
      ...
      <OTPInput
        ...
        rounded={rounded}
        length={6}
        label="Verification Code - Box Variant"
      />
      <OTPInput
        size={size}
        rounded={rounded}
      ...
      <div className="flex flex-col gap-3">
        ...
        />
        <DatePicker
          placeholder="Range with 2 months"
          triggerClassName="w-[15rem]"
          mode="range"
          doubleCalendar={true}
          showDateRangeShortcut={true}
        />
      </div>
      <FileUpload
        value={file}
      ...
      <div className="my-4 flex w-full flex-col gap-4">
        <Slider
          label="Test label"
          prefixIcon={<BellOff size={20} />}
          suffixIcon={<BellRing size={20} />}
        />
