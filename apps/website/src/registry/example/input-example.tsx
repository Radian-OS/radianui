...
const InputExample = () => {
	...
	return (
		<div className="mb-20 mt-4 flex max-w-[25rem] flex-col gap-2">
			...
			<Input placeholder="Controlled Input" value={input} onChange={(e) => setInput(e.target.value)} />
			<Input placeholder="Disabled" disabled={true} />
			<Input placeholder="With error" />

			{/* <Divider margin="4" /> */}

			<Input placeholder="Placeholder here" type="email" />

			{/* <Divider margin="4" /> */}

			<Password placeholder="Password here" />
			<Password placeholder="Disabled" disabled={true} />
			<Password />

			{/* <Divider margin="4" /> */}
			{/* 
			<NumberInput label="Number" placeholder="Placeholder" showStepper={false} /> */}
			<Input placeholder="Placeholder here" type="url" />
			...
			{/* <span>{phone}</span> */}
			{/* <PhoneNumber defaultCountryCode="NP" onValueChange={setPhone} /> */}
			...
			{/* 
			<TimePicker interval={25} placeholder="Select Time" className="w-[10rem]" />

			<TimePicker is24Hour={true} placeholder="Select Time" className="w-[10rem]" />

			<TimePicker placeholder="Select Time" className="w-[10rem]" minTime="00:05" allowEmptySelection={false} /> */}
