...
export default function DrawerExample() {
  ...
  const variant = selectVariants[0] as
    | "float"
    | "default"
    | "rounded"
    | undefined;
  const position = selectPosition[0] as
    | "right"
    | "bottom"
    | "left"
    | "top"
  ...
  const backdrop =
    selectBackdrop[0] === "null"
      ? null
      : (selectBackdrop[0] as "blur" | "overlay" | undefined);
    ...
    <div className="flex flex-col gap-4 p-5">
      ...
      <div className="flex gap-3">
        <Select
          ...
          selectedValues={selectVariants}
          onSelectedChange={setSelectVariants}
        ...
        <Select
          ...
          selectedValues={selectPosition}
          onSelectedChange={setSelectPosition}
          selectionMode="single"
        >
        ...
        <Select
          placeholder="Show handle"
          selectedValues={selectHandle}
          onSelectedChange={setSelectHandle}
          selectionMode="single"
        >
        ...
        <Select
          ...
          selectedValues={selectBackdrop}
          onSelectedChange={setSelectBackdrop}
          selectionMode="single"
        >
      ...
      {variant && position && (
        ...
        >
          <DrawerHeader>
            ...
            <span className="body-sm text-fg2">
              Stress testing the drawer component with an example
            </span>
          </DrawerHeader>
            ...
            <DrawerFooter>
              <TabsContent className="flex flex-col gap-4" value="invoice">
                ...
                <div>
                  <ul className="flex flex-col gap-3">
                    ...
                    <li className="flex gap-2">
                      <span className="text-fg3 body-sm w-1/2">
                        Customer ID
                      </span>
                    ...
                    <li className="flex gap-2">
                      ...
                      <span className="body-sm w-1/2">
                        Credit card ending with 0044
                      </span>
                    </li>
                    <li className="flex gap-2">
                ...
                <div className="body-sm text-fg3 bg-bg3 flex items-center justify-center rounded-[0.75rem] p-5">
                  Sample Container
                </div>
              </TabsContent>
              <TabsContent
              ...
              >
                ...
                <div className="flex flex-col gap-1 text-center">
                  ...
                  <span className="body-sm text-fg2">
                    This content sample does not have any new updates, please
