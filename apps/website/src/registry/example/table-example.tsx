    ...
    cell: ({ row }: { row: { original: PersonData } }) => (
      <>
        <Badge
          ...
          size="20"
          className={cn(
            row.original.status === "Inactive" && "bg-bg3 text-fg2",
    ...
    <div className="pb-10">
      ...
      <div className="mb-14 flex flex-wrap gap-4">
        <div className="flex flex-col">
          ...
          <Select
            label="Vertical Line"
            placeholder="Vertical Line"
            selectedValues={verticalLine}
            onSelectedChange={setVerticalLine}
          >
            <SelectItem value="true">True</SelectItem>
            <SelectItem value="false">False</SelectItem>
          </Select>
        ...
        <div className="flex flex-col">
          <Select
            ...
            onSelectedChange={setTableHeight}
          >
        ...
        <div className="flex flex-col">
          <Select
            label="Outine"
            placeholder="Outline"
            selectedValues={dense}
            onSelectedChange={setDense}
          >
            <SelectItem value="true">True</SelectItem>
            <SelectItem value="false">False</SelectItem>
          </Select>
      ...
      <div className="mt-10 flex flex-wrap gap-4">
        ...
        <Select
          ...
          selectedValues={rowPer}
          onSelectedChange={setRowPer}
          className="w-max"
        >
          <SelectItem value="true">True</SelectItem>
          <SelectItem value="false">False</SelectItem>
