...
// 				<div className="flex flex-col">
// 					<Select label="Checkbox" selectedValues={checkbox} onSelectedChange={setCheckbox}>
// 						<SelectItem value="true">True</SelectItem>
// 						<SelectItem value="false">False</SelectItem>
// 					</Select>

// 					<Select label="Vertical Line"  selectedValues={verticalLine} onSelectedChange={setVerticalLine}>
// 						<SelectItem value="true">True</SelectItem>
// 						<SelectItem value="false">False</SelectItem>
// 					</Select>
// 				</div>
...
// 				<div className="flex flex-col">
// 					<Select label="Stripe" selectedValues={stripe} onSelectedChange={setStripe}>
// 						<SelectItem value="true">True</SelectItem>
// 						<SelectItem value="false">False</SelectItem>
// 					</Select>
