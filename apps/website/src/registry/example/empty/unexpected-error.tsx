	...
	return (
		<Empty>
			...
			<EmptyHeader>
				...
				<EmptyDescription>Something went wrong. Please try again later or refresh the page</EmptyDescription>
			</EmptyHeader>
			<EmptyAction>
		...
		<svg width={126} height={88} viewBox="0 0 126 88" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
			<g filter="url(#filter0_d_1642_2500)">
				...
				<path
					...
					className="fill-bg"
				/>
				<rect x={43} y={46} width={40} height={5} rx={1} className="fill-primary-focus" />
				<rect x={51} y={54} width={24} height={5} rx={1} className="fill-primary-focus" />
			</g>
			<defs>
				<filter id="filter0_d_1642_2500" x={0} y={0} width={126} height={88} filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
					...
					<feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_1642_2500" />
					<feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_1642_2500" result="shape" />
				</filter>
			</defs>
		</svg>
	)
