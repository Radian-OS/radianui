	...
	return (
		<Empty>
			...
			<EmptyHeader>
				...
				<EmptyDescription>Once you upload, your files will show up here</EmptyDescription>
			</EmptyHeader>
			<EmptyAction>
...
function EmptyMediaContent(props: SVGProps<SVGSVGElement>) {
	return (
		<svg width={101} height={81} viewBox="0 0 101 81" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
			<rect x={0.5} y={0.5} width={100} height={80} rx={10} className="fill-bg stroke-primary-border" strokeDasharray="4 4" />
			<path d="M50.5 11C60.165 11 68 18.835 68 28.5C68 38.165 60.165 46 50.5 46C40.835 46 33 38.165 33 28.5C33 18.835 40.835 11 50.5 11Z" className="fill-bg" />
			<path d="M50.5 11C60.165 11 68 18.835 68 28.5C68 38.165 60.165 46 50.5 46C40.835 46 33 38.165 33 28.5C33 18.835 40.835 11 50.5 11Z" className="stroke-soft" />
			<path
			...
			/>
			<rect x={15.5} y={52.5} width={70} height={6} rx={2} className="fill-primary-focus" />
			<rect x={28.5} y={62.5} width={44} height={6} rx={2} className="fill-primary-focus" />
		</svg>
	)
}
