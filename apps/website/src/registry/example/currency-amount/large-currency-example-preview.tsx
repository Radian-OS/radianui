...
const LargeCurrencyInputPreview = () => {
	...
	export default LargeCurrencyInputPreview
	`
	...
	return (
		<Tabs defaultValue="preview">
			...
			<TabsContent value="code">
				<CodeSnippet title="large-currency-input.tsx" showLineNumber className="h-[420px]" code={code} />
			</TabsContent>
		</Tabs>
	)
}
