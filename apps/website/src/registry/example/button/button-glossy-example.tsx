...
const ButtonGradientExample = () => {
	return (
		<div className="w-50 flex flex-col items-center justify-center gap-3">
			...
			<Button color="info" className="w-full" variant="glossy">
				Info
			</Button>
			<Button color="success" className="w-full" variant="glossy">
				Success
			</Button>
			<Button color="warning" className="w-full" variant="glossy">
				Warning
			</Button>
			<Button color="error" className="w-full" variant="glossy">
				Error
			</Button>
			<Button color="neutral" className="w-full" variant="glossy">
				Neutral
			</Button>
