...
const ButtonElevatedExample = () => {
	return (
		<div className="w-50 flex flex-col items-center justify-center gap-3">
			<Button className="active:bg-primary w-full shadow-[0_2px_4px_0_rgba(35,20,85,0.16),0_-2px_0_0_rgba(0,0,0,0.3)_inset] hover:shadow-[0_2px_4px_0_rgba(35,20,85,0.12),0_-2px_0_0_rgba(0,0,0,0.2)_inset] active:shadow-[0_10px_12px_0_rgba(35,19,85,0.12),0_2px_4px_0_rgba(35,20,85,0.12)]">
				Elevated Button
			</Button>
			<Button
