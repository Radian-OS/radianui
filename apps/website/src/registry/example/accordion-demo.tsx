...
const AccordionDemo = ({ size, variant, collapsible }: AccordionDemoType) => {
	return (
		<Accordion variant={variant} size={size} {...(collapsible ? { collapsible } : {})}>
			<AccordionItem value="value 1">
				<AccordionTrigger>What is Radian?</AccordionTrigger>
				<AccordionContent>
					Lorem ipsum dolor sit amet, consectetur adipisicing elit. Esse, facere. Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam
