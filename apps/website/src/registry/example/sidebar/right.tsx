...
export default function RightSidebarPreview() {
	return (
		<div className="h-[700px]">
			<SidebarProvider>
				{/* Using absolute positioning to prevent layout shift in the preview — remove when using fullscreen. */}
				<Sidebar side="right" variant="floating" collapsible="icon" className="[&>[data-slot=sidebar-inner]]:bg-fill2-alpha absolute">
