...
const organization = {
	name: "Algorithm Aces",
	logo: "/media/organization-1.png",
	description: "We offer mock interviews and exam prep to help you ace your next technical challenge.",
	members: [
		{
			name: "Maya Rios",
...
export default function HoverCardGroupQuickView() {
	return (
		<HoverCard>
			<HoverCardTrigger>
					...
					<div className="border-soft bg-fill2 flex items-center justify-center gap-1 rounded-full border p-1.5 pe-3.5">
						<div className="flex -space-x-2">
							{organization.members.slice(0, 4).map((member) => (
								<Avatar size="24" className="border-bg border-2 hover:z-10" key={member.name}>
									<AvatarImage src={member.image} />
									<AvatarFallback>{member.name.charAt(0)}</AvatarFallback>
								</Avatar>
							))}
						</div>
						<span className="text-fg-secondary text-sm">+12k</span>
					</div>
				</div>
