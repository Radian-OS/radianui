...
// 		width: `${size}px`,
// 		height: `${size}px`,
// 		border: `${Math.round(size! * 0.1)}px solid ${color || "currentColor"}`,
// 		animation: "spinner-bulqg1 0.8s infinite linear alternate, spinner-oaa3wk1 1.6s infinite linear",
// 	}
...
// function SnakeSpinner({ size, color, "aria-label": ariaLabel, ...props }: SpinnerProps) {
// 	return (
// 		<>
// 			<style>
// 				{`
...
// 			}`}
// 			</style>
// 			<svg className="snake-spinner">
// 				<circle cx="70" cy="70" r="70" className="snake-spinner-circle"></circle>
// 			</svg>
// 		</>
// 	)
// }

// const SnakeSpinner = ({ size = 50, strokeWidth = 8, color = "#514b82", className = "" }) => {
// 	const radius = (size - strokeWidth) / 2
// 	const circumference = 2 * Math.PI * radius

// 	return (
// 		<div className={`inline-block ${className}`} style={{ width: size, height: size }}>
// 			<svg width={size} height={size} viewBox={`0 0 ${size} ${size}`} className="loader-svg">
// 				<circle cx={size / 2} cy={size / 2} r={radius} fill="none" stroke={color} strokeWidth={strokeWidth} strokeLinecap="round" className="loader-circle" />
// 			</svg>
...
// 					animation: loader-sweep 0.8s infinite linear alternate;
// 				}
...
// 					}
// 					12.5% {
// 						stroke-dashoffset: ${circumference * 0.875};
// 					}
// 					25% {
...
const SnakeSpinner = ({ size, color, className, "aria-label": ariaLabel }: SpinnerProps) => {
	const spinnerStyle = {
		width: "100%",
		height: "100%",
		border: `${Math.round(size! * 0.07)}px solid ${color || "currentColor"}`,
		animation: "spinner-bulqg1 0.8s infinite linear alternate, spinner-oaa3wk1 1.6s infinite linear",
	}
