...
const useHoverCardContext = () => {
  ...
  if (!context)
    throw new Error("useHoverCardContext must be used within <HoverCard/>");
  return context;
};
...
const HoverCardContent = ({
  ...
  return (
    <HoverCardPrimitive.Content
      ...
      className={cn(
        "bg-bg1 text-fg1 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-50 w-64 rounded-md border p-4 shadow-md outline-hidden",
        className,
      )}
      {...props}
    >
