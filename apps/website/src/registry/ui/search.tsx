...
function SearchInput({
  ...
  const [showResultsInternal, setShowResults] = React.useState(
    defaultShowSearchResults,
  );
  const showResults = showSearchResults
    ? showSearchResults
    : showResultsInternal;
  ...
  return (
    <Popover open={showResults} align="start">
      ...
      <PopoverContent
        ...
        className={cn(
          "no-scrollbar z-50 max-h-88 overflow-y-scroll p-0",
          props.classNames?.searchResults,
        )}
