...
const selectTriggerVariants = cva(
	"cn-select-trigger flex w-full items-center transition-shadow outline-none [&>span]:line-clamp-1",
	{
		variants: {
			size: {
...
function SelectItem({ className, children, ...props }: SelectItemProps) {
	...
	return (
		<SelectPrimitive.Item
			...
			className={cn(
				"cn-select-item relative flex w-full cursor-pointer items-center outline-hidden select-none",
