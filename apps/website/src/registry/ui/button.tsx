...
export const buttonVariants = cva(
	"focus-visible:ring-offset-bg box-border inline-flex w-fit items-center justify-center whitespace-nowrap hover:cursor-pointer focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none disabled:pointer-events-none",
	{
		variants: {
			...
			size: {
				"28": "cn-btn-size-28 px-1 text-[13px] leading-4.5 [&>svg]:size-4",
				"32": "cn-btn-size-32 px-1 text-sm [&>svg]:size-4.5",
				"36": "cn-btn-size-36 px-1 text-sm [&>svg]:size-5",
				"40": "cn-btn-size-40 px-1 text-sm [&>svg]:size-5",
				"44": "cn-btn-size-44 px-1 text-base [&>svg]:size-5",
				"48": "cn-btn-size-48 px-1 text-base [&>svg]:size-6",
			},
			loading: {
				true: "",
				false: "",
...
export const compactButtonVariants = cva(
	"focus-visible:ring-offset-bg-bg cn-compact-btn box-border inline-flex w-fit items-center justify-center whitespace-nowrap hover:cursor-pointer focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none",
	{
		variants: {
			variant: {
				strong: "",
...
export const iconButtonSizeVariants = cva("", {
	variants: {
		size: {
			"28": "cn-icon-btn-size-28 size-7 p-1.5 [&>svg]:size-4",
			"32": "cn-icon-btn-size-32 size-8 p-1.75 [&>svg]:size-4.5",
			"36": "cn-icon-btn-size-36 size-9 p-2 [&>svg]:size-5",
			"40": "cn-icon-btn-size-40 size-10 p-2.5 [&>svg]:size-5",
			"44": "cn-icon-btn-size-44 size-11 p-3 [&>svg]:size-5",
			"48": "cn-icon-btn-size-48 size-12 p-3 [&>svg]:size-6",
		},
		variant: {
			outline: "",
			default: "",
