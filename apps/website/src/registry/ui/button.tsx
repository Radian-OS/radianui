	...
	"inline-flex items-center justify-center box-border transition duration-200 transform rounded-lg disabled:opacity-50  focus-visible:ring-2 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 w-fit",
	{
		variants: {
			variant: {
				...
				ghost: "",
				"neutral-soft":
					"bg-bg-base font-medium hover:bg-fill-level1 focus-visible:outline-none focus-visible:ring-border-alpha disabled:drop-shadow-sm",
				"neutral-outline":
					"bg-bg-base font-medium outline-1 outline-border-alpha drop-shadow-xs hover:border-stroke-decorative hover:bg-fill-level2  focus-visible:ring-border-alpha",
			},
			size: {
		...
		compoundVariants: [
			...
			},
			{
				...
				color: "information",
				className:
					"bg-information font-semibold text-static-white hover:bg-information-hover   focus-visible:ring-information focus-visible:outline-none",
			},
			{
				variant: "strong",
				color: "success",
			...
			},
			{
				...
				color: "information",
				className:
					"bg-information-accent font-medium text-information hover:bg-information/15   focus-visible:ring-information-focus focus-visible:outline-none",
			},
			{
				variant: "soft",
				color: "success",
			...
			// Outline variant + colors (updated to use outline & ring)
			{
				variant: "outline",
				color: "primary",
				className: "bg-bg-base font-medium outline outline-primary-stroke text-primary hover:bg-primary-accent   focus-visible:ring-primary-stroke",
			},
			{
				variant: "outline",
				color: "information",
				className:
					"bg-bg-base font-medium outline outline-information-stroke text-information hover:bg-information-accent   focus-visible:ring-information-stroke",
			},
			{
				variant: "outline",
				color: "success",
				className: "bg-bg-base font-medium outline outline-success-stroke text-success hover:bg-success-accent   focus-visible:ring-success-stroke",
			},
			{
				variant: "outline",
				color: "error",
				className: "bg-bg-base font-medium outline outline-error-stroke text-error hover:bg-error-accent   focus-visible:ring-error-stroke",
			},
			{
				variant: "outline",
				color: "warning",
				className: "bg-bg-base font-medium outline outline-warning-stroke text-warning hover:bg-warning-accent   focus-visible:ring-warning-stroke",
			},
