...
const Cli = () => {
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-8">
        <p>
          Use the init command to initialize configuration and dependencies for
          a new project.
        </p>
        <p>
          The init command installs dependencies, adds the radianos util,
...
Options:
  ...
  -h, --help       display help for command`}
      ...
      <div className="flex flex-col gap-8">
        <p>
          Use the add command to add components and dependencies to your
          project.
        </p>
        <PackageManagerTabs
          isNpx={true}
