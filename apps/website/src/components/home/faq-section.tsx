	...
	return (
		<div className="py-15 flex w-full flex-col items-center gap-8 px-5 xl:py-36">
			<div className="max-w-360 relative w-full">
				...
				<svg className="absolute bottom-[50%] left-[60px] max-h-[775px]" fill="none" viewBox="0 0 1939 775" xmlns="http://www.w3.org/2000/svg">
					<path
				...
				<svg className="absolute -left-[50px] top-[50%] max-h-[341px]" viewBox="-80 0 350 341" xmlns="http://www.w3.org/2000/svg">
					<path
