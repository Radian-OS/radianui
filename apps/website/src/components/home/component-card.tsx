		...
		<Link href={url} className="flex w-full flex-col items-center">
			...
			<div className="flex w-full flex-col items-start gap-3">
				<div className="bg-fill2 flex w-full justify-center rounded-md">
					<Image width={282} height={228} alt={alt} src={thumbnail} className="max-h-[228x] max-w-[282px] dark:hidden" />
					<Image width={282} height={228} alt={alt} src={thumbnailDark} className="hidden max-h-[228px] max-w-[282px] dark:block" />
				</div>
