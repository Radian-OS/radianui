	...
	return (
		<BentoCardGrid gridRef={gridRef} className="flex flex-col px-7 sm:px-12">
			<div className="relative select-none">
				...
				<svg width="35" height="271" viewBox="0 0 35 271" className="absolute left-9" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path d="M0.5 0V33.0294C0.5 36.212 1.76428 39.2643 4.01472 41.5147L30.4853 67.9853C32.7357 70.2357 34 73.288 34 76.4706V277.5" stroke="var(--color-soft)" />
					<path
				...
				<div className="bg-elevation-negative border-soft absolute left-32 top-40 rounded-xl border px-1.5 py-2">
					<div className="flex h-full flex-col gap-2">
						...
						<div className="border-soft bg-elevation-level1 flex h-full w-full flex-col rounded-lg border p-4">
							<p className="text-fg-secondary whitespace-nowrap text-[13px] font-normal" style={{ fontFamily: '"JetBrains Mono", monospace' }}>
