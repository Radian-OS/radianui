...
export const Marquee = () => {
	...
	return (
		<div className="flex w-full select-none flex-col items-center gap-4">
				...
				<div className="relative flex items-center justify-center gap-3">
					{componentStyle.map((component, index) => (
						<Badge
							...
							size="28"
							color="primary"
							className="border-primary rounded-full border text-sm">
							{component}
						</Badge>
					))}
				</div>
			...
			<div
				onClick={handleClick}
				className="z-1 relative flex min-h-[400px] w-full cursor-pointer items-center justify-center">
				...
				<motion.div
					...
					className="not-md:hidden absolute inset-0">
					<FlickeringGrid
						squareSize={4}
						gridGap={6}
						color="#6B7280"
