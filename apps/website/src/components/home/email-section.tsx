...
export default function EmailSection() {
  ...
  return (
    <div className="mx-auto max-w-310">
      <div
        id="body"
        className="flex flex-col gap-8 px-4 py-6 md:px-6 lg:p-10 lg:pb-15"
      >
        ...
        <div className="flex w-full flex-col items-center justify-center gap-8 rounded-xl border px-6 py-6 text-center md:px-10 md:py-15 lg:flex-row lg:justify-between">
          <div className="flex flex-col gap-2 sm:gap-3">
            ...
            <p className="body-base text-fg2">
              Subscribe to get latest updates, tips, & exclusive offers from
              Radian.
            </p>
          </div>
          <form
