		...
		<Link
			...
			<div className="flex items-center justify-between">
				<svg
					...
					/>
					<path
						d="M9.72229 1.25V7.08331H12.639C14.2498 7.08331 15.5556 5.77749 15.5556 4.16666C15.5556 2.55584 14.2498 1.25 12.639 1.25H9.72229Z"
						fill="#FF7262"
					/>
					<path
						d="M3.88889 4.16667C3.88889 5.77749 5.19472 7.08332 6.80555 7.08332H9.72222V1.25H6.80555C5.19472 1.25 3.88889 2.55583 3.88889 4.16667Z"
						fill="#F24E1E"
					/>
					<path
						d="M3.88889 10.0002C3.88889 11.611 5.19472 12.9168 6.80555 12.9168H9.72222V7.0835H6.80555C5.19472 7.0835 3.88889 8.38936 3.88889 10.0002Z"
						fill="#A259FF"
					/>
				</svg>
			...
			<div className="flex flex-col gap-1 px-0.5">
				<p className="text-fg leading-5 font-medium">
					Get Radian Design System Kit Figma
				</p>
				<p className="text-fg-tertiary leading-5 font-normal">
					radianui.com/figma
				</p>
			</div>
		</Link>
