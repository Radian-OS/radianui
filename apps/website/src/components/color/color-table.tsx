				...
				<Table className="text-fg-secondary border-border w-full min-w-[650px] table-auto border-separate border-spacing-0 overflow-hidden rounded-lg border">
					<TableHeader className="bg-fill1">
						<TableRow className="bg-fill1">
							<TableHead className="border-border w-[160px] border-r border-b px-2 py-3 text-start text-sm font-medium">
								Token
							</TableHead>
							<TableHead className="border-border w-[150px] border-r border-b px-2 py-3 text-start text-sm font-medium">
								Hex Value
							</TableHead>
					...
					<TableBody className="">
						{data.map((prop) => (
							<TableRow key={prop.token} className="last:[&>td]:border-b-0">
								<TableCell className="border-soft w-[160px] border-r border-b px-2 py-3 text-sm">
								...
								<TableCell className="border-soft w-[150px] border-r border-b px-2 py-3 text-sm">
