...
const components: MDXComponents = {
  ...
  h5: ({
    ...
    <h5
      className={cn("heading-5 mt-9 mb-4 font-semibold!", className)}
      {...props}
    >
      {children}
    </h5>
  ...
  p: ({
    ...
    <p
      className={cn("text-primary-foreground text-base", className)}
      {...props}
    >
      {children}
    </p>
  ...
  table: ({
    ...
    <div className="no-scrollbar overflow-x-scroll">
      <table
        className={cn("border-stroke w-full table-auto border", className)}
        {...props}
      >
        {children}
      </table>
  ...
  th: ({
    ...
    <th
      className={cn(
        "border-stroke border px-3 py-2.5 text-left text-sm font-semibold",
        className,
      )}
      {...props}
    >
  ...
  td: ({
    ...
    <td
      className={cn("border-stroke border px-3 py-2.5 text-sm", className)}
      {...props}
    >
      {children}
    </td>
  ...
  ul: ({ children }: { children?: React.ReactNode }) => (
    <ul className="[&>li>strong]:text-fg2 mt-2 ml-4 flex list-disc flex-col gap-2 [&>li>strong]:font-medium">
      {children}
    </ul>
  ),
  Preview: ({
    ...
    <div
      className={cn(
        "mb-5 flex min-h-[30rem] items-center justify-center rounded-lg border p-10",
        className,
      )}
      {...props}
    >
