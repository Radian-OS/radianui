...
export default function Navbar() {
  ...
  return (
    <nav className="bg-bg1 border-stroke-decorative flex items-center justify-between border-b px-4 py-3 lg:h-15.5">
        ...
        >
          <ModalTrigger asChild>
            <Button isIcon variant="neutral-outline" className="gap-2">
              <Search />
              <span className="text-fg2 hidden grow text-start text-sm font-normal xl:inline xl:w-28">
                Search
              </span>
              <Badge
                className="bg-bg4 text-fg2 hidden items-center justify-center border-none lg:flex"
                size="20"
              >
                CTRL + K
              </Badge>
          ...
          <ModalContent className="px-0 py-2">
            ...
            <div className="flex h-100 flex-col overflow-y-scroll rounded-lg">
              ...
              {filteredItems.length > 0 ? (
                filteredItems.map((section, sectionIndex) => (
                  <main key={section.title} className="text-sm font-normal">
                    <div className="px-2.5">
                      <h1 className="text-fg3 flex items-center gap-1.5 px-1.75 py-1.5">
                        {section.title}
                      </h1>
                ...
                <div className="text-fg2 flex h-full items-center justify-center">
                  No items found
                </div>
              )}
            </div>
