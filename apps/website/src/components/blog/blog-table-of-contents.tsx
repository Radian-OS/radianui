							...
							return (
								<li key={heading.id} className="relative">
									<Link
										...
										className={cn(
											"text-fg-secondary hover:text-fg group relative block py-2 text-sm font-normal transition-colors",
											heading.level <= 2 ? "px-5" : "px-7",
										...
										<div
											className={cn(
												"bg-primary absolute top-1/2 left-0 h-8 w-0.5 -translate-y-1/2 transition-opacity duration-150",
