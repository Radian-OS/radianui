      ...
      <div className="flex flex-col gap-[30px] border-l pl-[2rem]">
        <div className="flex flex-col gap-[10px]">
          <div className="relative">
            <span className="heading-6 bg-border absolute left-[-3rem] flex h-8 w-8 items-center justify-center rounded-full">
              1
            </span>
...
Success! Project initialization completed. You may now add components.`}
        ...
        <div className="flex flex-col gap-[10px]">
          ...
          <PackageManagerTabs
            ...
            language={language}
            pkg={pkg}
            code={"radianos add button"}
          />
          <p>
            The command above will add the <code>Button</code> component to your
