...
<PackageManagerTabs
	commands={{
		npm: "npm install tailwindcss-animate class-variance-authority clsx tailwind-merge lucide-react tw-animate-css",
		yarn: "yarn add tailwindcss-animate class-variance-authority clsx tailwind-merge lucide-react tw-animate-css",
		pnpm: "pnpm add tailwindcss-animate class-variance-authority clsx tailwind-merge lucide-react tw-animate-css",
		bun: "bun add tailwindcss-animate class-variance-authority clsx tailwind-merge lucide-react tw-animate-css",
	}}
/>
