...
<CodeSnippet
	title="globals.css"
	showLineNumber
	code={`@import url("https://fonts.googleapis.com/css2?family=Inter:ital,opsz,wght@0,14..32,100..900;1,14..32,100..900&family=Poppins:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,100;1,200;1,300;1,400;1,500;1,600;1,700;1,800;1,900&display=swap");
@import "tailwindcss";
...
@theme static {
    ...
    /* 2% opacity */
    /* fill */
    --color-fill1: hsl(230, 6%, 98%);
    --color-fill2: hsl(230, 6%, 96%);
    --color-fill3: hsl(230, 6%, 88%);
    --color-fill4: hsl(230, 6%, 84%);
    /* fill-inverse */
    --color-inverse-fill1: color-mix(in srgb, hsl(0, 0%, 100%), transparent 98%);
    /* 2% opacity */
    --color-inverse-fill2: color-mix(in srgb, hsl(0, 0%, 100%), transparent 96%);
    /* 4% opacity */
    --color-inverse-fill3: color-mix(in srgb, hsl(0, 0%, 100%), transparent 92%);
    /* 8% opacity */
    --color-inverse-fill4: color-mix(in srgb, hsl(0, 0%, 100%), transparent 84%);
    /* 16% opacity */
    /* static */
    --color-white: hsl(0, 0%, 100%);
    --color-black: hsl(230, 6%, 4%);
    /* inverse */
    --color-black-inverse: hsl(230, 6%, 4%);
    --color-white-inverse: hsl(0, 0%, 100%);
    /* Breakpoints */
...
.dark {
    ...
    --color-primary-hover: hsl(251, 58%, 41%);
    ...
    /* fill */
    --color-fill1: hsl(230, 6%, 6%);
    /* 2% opacity */
    --color-fill2: hsl(230, 6%, 8%);
    /* 4% opacity */
    --color-fill3: hsl(230, 6%, 12%);
    /* 8% opacity */
    --color-fill4: hsl(230, 6%, 16%);
    /* 16% opacity */
    /* fill-inverse */
    --color-inverse-fill1: color-mix(in srgb, hsl(240, 5%, 4%), transparent 98%);
    /* 2% opacity */
    --color-inverse-fill2: color-mix(in srgb, hsl(240, 5%, 4%), transparent 96%);
    /* 4% opacity */
    --color-inverse-fill3: color-mix(in srgb, hsl(240, 5%, 4%), transparent 92%);
    /* 8% opacity */
    --color-inverse-fill4: color-mix(in srgb, hsl(240, 5%, 4%), transparent 84%);
    /* 16% opacity */
    /* static */
    --color-white: hsl(0, 0%, 100%);
    --color-black: hsl(230, 6%, 4%);
    /* inverse */
    --color-black-inverse: hsl(0, 0%, 100%);
    --color-white-inverse: hsl(230, 6%, 4%);
