...
A composable and accessible sidebar. Supports four themes, three variants, collapsible modes, resizable mode, a mobile drawer, and a keyboard shortcut out of the box.
